...
//by piercus
//tips from http://stackoverflow.com/questions/10167534/how-to-find-out-what-type-of-a-mat-object-is-with-mattype-in-opencv
...
NAN_METHOD(Matrix::GetType){
  SETUP_FUNCTION(Matrix)


  string ty =  type2str( self->mat.type() );
  printf("Matrix: %s %dx%d \n", ty.c_str(), self->mat.cols, self->mat.rows );
